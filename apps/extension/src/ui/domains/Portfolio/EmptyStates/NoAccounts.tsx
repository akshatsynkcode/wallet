      ...
      >
        ...
        <span className={classNames("text-xs", fullscreen && "md:text-base")}>
          <Trans t={t}>
            ...
            <span className="text-primary font-bold">Dubai Customs universe</span>
          </Trans>
        </span>
      </header>
      ...
      <div className="flex flex-col gap-8">
        <div className="flex gap-8">
          ...
          <GetStartedButton className="flex flex-1 flex-col gap-4" onClick={onTryTalisman}>
            ...
            <div className="text-tiny text-body-secondary">
              {t("Explore Dubai Customs without importing an account")}
            </div>
          </GetStartedButton>
        </div>
        ...
        >
          <div className="flex flex-col gap-4">
            ...
            <div className="text-tiny text-body-secondary">
              {t("Discover how Dubai Customs can elevate your web3 journey")}
            </div>
          </div>
