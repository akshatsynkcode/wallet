  ...
  return (
    <Drawer className="h-full" containerId="main" anchor="bottom" isOpen={isOpen} onDismiss={close}>
      <div className="flex h-full w-full flex-col bg-black">
        <header className="border-grey-800 box-border flex h-36 w-full items-left justify-between gap-6 border-b px-12">
        <img src="logo.svg" alt="" className="logo-extension mt-6"/>
