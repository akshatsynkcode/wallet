  ...
  const submit = useCallback<SubmitHandler<FormData>>(
    async ({ password }) => {
      try {
        ...
        } else throw new Error(t("Dubai Customs Wallet access denied"))
      } catch (err) {
    ...
    <PopupLayout>
      ...
      >
        <div className="mt-[60px]">
          ...
          <img src="/logo.svg" alt="" className="logo-white"/>
        </div>
        <h1 className="font-surtExpanded mt-[34px] text-lg">{t("Enter The Password For Dubai Customs Wallet")}</h1>
